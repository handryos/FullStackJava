...
<!-- 										<div class="form-group"> -->
											...
											<br>
													...
													<option value="${viagem.uf}" disabled selected>${viagem.uf}</option>
													</select>
											<br>
											...
											<br>
													...
													<option value="${viagem.cidade}" disabled selected>${viagem.cidade}</option>
												</select>
	...
	function submitData(){
		...
		var jayson = '{"id": "'+${viagem.id}+'", "username": "'+name+'","email": "'+email+'", "cidade": "'+cidade+'", "uf": "'+uf+'" }';
		console.log(jayson);
		$.ajax({
			type: "PUT",
			url: "http://localhost:8080/posts/"+${viagem.id},
			data: jayson,
	...
	//    messages: {
	//      email: {
	//        required: "Por favor informe um email v�lido",
	// 	   minlength: 2
	//      },
	//    },
